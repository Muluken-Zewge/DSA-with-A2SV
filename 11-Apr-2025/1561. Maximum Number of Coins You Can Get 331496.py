...
class Solution:
    def maxCoins(self, piles: List[int]) -> int:
        ...
        max_idx = len(piles) - 1
        max_coins = 0
#in each iteration, a triplet with the two largest elements and one smallest element is formed. add the middle number(the second largest) in to the max_coins in each iteration
